...
- 中文：AI 正文建议长度放宽至 700–1000 个中文字符，信息确有需要时最多 1200 个字符；API 输出预算同步放宽。
...
- English: Added optional locally stored questions, fully separated Liuyao/Tarot AI identities, richer deterministic Tarot synthesis, longer AI responses, virtual accessibility nodes, compact-screen layout handling, and a split Activity/View architecture.
